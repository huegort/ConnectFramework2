			...
			<ol class="property-list contact">
				...
				<li class="fieldcontain">
					<span id="institution-label" class="property-label"><g:message code="contact.institution.label" default="Institution" /></span>
						...
						<span class="property-value" aria-labelledby="institution-label"><g:link controller="institution" action="show" id="${contactInstance?.institution?.id}">${contactInstance?.institution?.encodeAsHTML()}</g:link></span>
