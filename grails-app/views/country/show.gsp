			...
			<ol class="property-list country">
				...
				<li class="fieldcontain">
					<span id="region-label" class="property-label"><g:message code="country.region.label" default="Region" /></span>
						...
						<span class="property-value" aria-labelledby="region-label"><g:link controller="region" action="show" id="${countryInstance?.region?.id}">${countryInstance?.region?.encodeAsHTML()}</g:link></span>
