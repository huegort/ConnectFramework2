...
<div class="main-body">
    <div class="grid">
        <div class="grid__col grid__col--12-of-12">
            ...
            <h3> <span class="property-value" aria-labelledby="level-label"><g:fieldValue bean="${partnershipLevel}" field="name"/></span> </h3>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Description of Partnership Level</h3>
                </div>
                <div class="panel-body">
                    <span class="property-value" aria-labelledby="level-label"><g:fieldValue bean="${partnershipLevel}" field="description"/></span>
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                    <div id="institutionDiv" >
                        <fieldset class="form">
                            ...
                            <g:else>
                                <g:render template="/commontemplates/institutionDisplay" model="[institution: institution]"/>
                            </g:else>
                        ...
                        <div class="panel-body">
                            ...
                            <div id="approvalDiv" >
                                <fieldset class="form">
                                    ...
                                    <g:render template="/commontemplates/approvalform"  model="[approvers: partnershipLevel.possibleApprovers, endorsers: partnershipLevel.possibleEndorsers]"/>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="criteriaDiv" >
                                ...
                                <fieldset class="form">
                                    <g:render template="/commontemplates/criteriadataform"  var="criteria" collection="${partnershipLevel.criteria}"/>
                                </fieldset>

                            </div>
                            <fieldset class="buttons">
                                <g:submitButton id ="submitCriteria" name="create" class="save" value="${message(code: 'default.button.create.label', default: 'Create')}" />
                            </fieldset>
                        </div>
                    </div>
                </div>
